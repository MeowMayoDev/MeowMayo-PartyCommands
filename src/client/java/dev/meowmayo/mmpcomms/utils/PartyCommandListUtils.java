package dev.meowmayo.mmpcomms.utils;
...
public class PartyCommandListUtils {
    ...
    public static void init() {
        ...
        File configDir = FabricLoader.getInstance().getConfigDir().resolve("meowmayo").toFile();
        // we dont check if the dir exists because the config loader does that (probably)
